...
export default function SOSPage() {
  const { activeAlert, createSosAlert, clearActiveAlert } = useSafety();
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 xl:grid-cols-[0.85fr_1.15fr]">
        <Card>
          <p className="text-sm font-bold uppercase text-brand-700 dark:text-brand-100">
            Emergency Module
          </p>
          ...
          <p className="mt-3 leading-7 text-slate-600 dark:text-slate-300">
            Press the emergency button to start a controlled SOS flow with
            confirmation, countdown, location sharing and incident tracking.
          </p>
      ...
      {isSent && (
        <Card className="border-roseguard-200 bg-roseguard-50/80 dark:border-roseguard-500/20 dark:bg-roseguard-500/10">
          ...
          <p className="mt-2 text-sm leading-6 text-slate-700 dark:text-slate-200">
            Trusted contacts, nearby verified responders and support teams have
            received your live incident details.
          </p>

          <div className="mt-5">
            <Button variant="secondary" onClick={cancelSOS}>
              Cancel SOS
            </Button>
          </div>
        </Card>
        ...
        <Card>
          ...
          <dl className="mt-5 grid gap-4">
            ...
            <div>
              ...
              <dd className="text-slate-950 dark:text-white">
                Location, profile summary, contacts and incident status
              </dd>
            </div>
            ...
            <div>
              ...
              <dd className="text-slate-950 dark:text-white">
                Limited to assigned and verified responders
              </dd>
            </div>
          </dl>
        </Card>
      ...
      >
        {isCountingDown ? (
          <CountdownTimer
            ...
            onComplete={completeSos}
          />
        ) : (
          <p className="leading-7 text-slate-600 dark:text-slate-300">
            This will notify trusted contacts and nearby verified responders
